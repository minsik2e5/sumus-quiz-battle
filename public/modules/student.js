...
export function updateRangeSummary(A) {
  ...
  const all = $('#practice-count option[value="all"]'); if (all) all.textContent = `선택 범위 전체 (${count}개)`;
