...
export async function service(state, method, path, body, token) {
  if (path === '/health') return { ok: true, version: '13.12.0', schema_version: state.schema_version, ready: state.profiles.some(p => p.role === 'teacher') || process.env.AUTH_PROVIDER === 'supabase' };
