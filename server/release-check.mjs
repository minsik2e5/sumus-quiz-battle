...
export async function runReleaseCheck() {
  ...
  try {
    ...
    assert(indexSource.includes('/v1325.css?v=13.30.0') && indexSource.includes('/v1326.css?v=13.30.0'), 'V13.30 learning style layers are connected');
    ...
    assert(indexHtml.includes('/app.js?v=13.30.0') && indexHtml.includes('/practice-enhancements.js?v=13.30.0') && indexHtml.includes('/v1325.css?v=13.30.0') && indexHtml.includes('/v1326.css?v=13.30.0') && indexHtml.includes('/v1327.css?v=13.30.0') && indexHtml.includes('/v1328.css?v=13.30.0') && indexHtml.includes('/v1329.css?v=13.30.0') && indexHtml.includes('/v1330.css?v=13.30.0') && sw.includes('sumus-voca-v13.30.0-cute-pets-onboarding'), 'V13.30 cache versions are active');
