...
export async function runReleaseCheck() {
  ...
  try {
    ...
    assert(indexHtml.includes('/app.js?v=13.43.0') && indexHtml.includes('/v1325.css?v=13.43.0') && indexHtml.includes('/v1326.css?v=13.43.0') && indexHtml.includes('/v1327.css?v=13.43.0') && indexHtml.includes('/v1328.css?v=13.43.0') && indexHtml.includes('/v1329.css?v=13.43.0') && indexHtml.includes('/v1330.css?v=13.43.0') && indexHtml.includes('/v1339.css?v=13.43.0') && indexHtml.includes('/v1340.css?v=13.43.0') && indexHtml.includes('/v1341.css?v=13.43.0') && sw.includes('sumus-voca-v13.43.0-stable'), 'V13.43 stabilization cache versions are active');
    ...
    assert(appJs.includes("import('./teacher-enhancements.js?v=13.43.0')") && appJs.includes("import('./student-enhancements.js?v=13.43.0')") && appJs.includes("ensureRoleEnhancements"), 'teacher and student enhancements load only for the active role');
