...
export async function runReleaseCheck() {
  ...
  try {
    ...
    assert(indexHtml.includes('/app.js?v=13.43.0') && indexHtml.includes('/app.bundle.css?v=13.43.0') && sw.includes("'/app.bundle.css'") && sw.includes('sumus-voca-v13.43.0-stable'), 'V13.43 stabilization cache versions and CSS bundle are active');
    ...
    assert(indexHtml.match(/rel="stylesheet"/g)?.length === 1 && indexHtml.includes('/app.bundle.css?v=13.43.0'), 'browser loads one production stylesheet instead of layered CSS requests');
